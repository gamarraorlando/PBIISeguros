...
public class SegundoParcial {
	...
	public void queSePuedaEmitirUnaPolizaDeAutos() {
		...
		assertEquals(NUMERO_DE_POLIZA, poliza.getGetNumeroDePoliza());
	...
	public void queSePuedaDenunciarUnSiniestroParaUnaPolizaDeVida() throws PolizaInexistente {
		...
		assertTrue(libra.getPoliza(numeroDePoliza).tuvoAlgunAccidente());
	...
	public void verificarQueNoSePuedaDenunciarUnSiniestroParaUnaPolizaQueNoExista() throws PolizaInexistente {
		...
		libra.agregarPoliza(new PolizaDeAuto(2, new Persona("Camila", 45987345, 24), 2000000.0, 5000.0));
		libra.agregarPoliza(new PolizaDeAuto(3, new Persona("Juan", 2745123, 24), 1500000.0, 4000.0));
		libra.agregarPoliza(new PolizaAccidentesPersonales(4, new Persona("Pedro", 455647345, 24), 2000000.0, 5000.0));
		libra.agregarPoliza(new PolizaCombinadoFamiliar(5, new Persona("Natalia", 45987345, 24), 2000000.0, 5000.0));
			
		libra.denunciarSiniestro(9);
